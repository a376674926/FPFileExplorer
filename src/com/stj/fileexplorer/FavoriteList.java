...
public class FavoriteList implements FavoriteDatabaseListener {
    ...
    public void update() {
        ...
        if (Util.isSDCardReady(mContext)) {
    ...
    public void initList() {
        ...
        //Deleted begin by lzy@20140411,for do not set default favorites.
        /*
    ...
    // add begin by xiaoye@20141117 modify : remove the related Data from
    // fravotite database after delete the fravotite file.
    private static final int MSG_FAVORITE_LIST_CHANGED = 110;
    private Handler fHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_FAVORITE_LIST_CHANGED:
                    update();
                    mListener.onFavoriteDatabaseChanged();
                    break;
            }
    ...
    public void onFavoriteDatabaseChanged() {
        ...
        message.what = MSG_FAVORITE_LIST_CHANGED;
