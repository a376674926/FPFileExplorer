 ...
 * @author ShunLi
 */
public class FileExplorerPreferenceActivity extends PreferenceActivity implements
        OnSharedPreferenceChangeListener {
    private static final String CATEGORY = "pref_key_category";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Util.isLimitViewPath(this)) {
            PreferenceCategory category = (PreferenceCategory) findPreference(CATEGORY);
            category.removePreference(mEditTextPreference);
            CheckBoxPreference readRootPreference = (CheckBoxPreference) findPreference(READ_ROOT);
            category.removePreference(readRootPreference);
        }
    }
    ...
    public static boolean isReadRoot(Context context) {
        if (Util.isLimitViewPath(context)) {
            return false;
        }
        SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(context);
